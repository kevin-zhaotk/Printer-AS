...
public class ZipUtil {
    ...
    public static void UnZipFolder(String zipFileString, String outPathString) throws Exception {
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            if (zipEntry.isDirectory()) {
                ...
                Debug.e(TAG,"--->path: " + outPathString + File.separator + szName);
    ...
    public static void UnZipFolder(String zipFileString, String outPathString,String  szName) throws Exception {
        ...
        ZipEntry zipEntry;
         while ((zipEntry = inZip.getNextEntry()) != null) {
            //szName = zipEntry.getName();
        	 Debug.e(TAG,"--->entry: " + zipEntry.getName());
            if (zipEntry.isDirectory()) {
                //获取部件的文件夹名
                ...
                Debug.e(TAG,outPathString + File.separator + szName);
                File file = new File(outPathString + File.separator + szName);
                if (!file.exists()){
                    Debug.e(TAG, "Create the file:" + outPathString + File.separator + szName);
                    file.getParentFile().mkdirs();
                    file.createNewFile();
                }
                // 获取文件的输出流
